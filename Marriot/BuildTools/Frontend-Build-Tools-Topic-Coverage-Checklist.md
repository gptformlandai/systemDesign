...
| 6 | Dev server | [Dev Server](./03-Optimization-DevServer-HMR/Dev-Server-File-Watching-HMR-Pipeline-Gold-Sheet.md) |
| 7 | HMR | [HMR](./03-Optimization-DevServer-HMR/HMR-Hot-Reload-Internals-State-Preservation-Gold-Sheet.md) |
| 8 | Webpack | [Webpack Deep Dive](./04-Bundler-Deep-Dives/Webpack-Deep-Dive-Loaders-Plugins-DevServer-Gold-Sheet.md) |
| 9 | Vite | [Vite Modern Dev Server](./04-Bundler-Deep-Dives/Vite-Modern-Dev-Server-Rollup-Production-Gold-Sheet.md) |
| 10 | Parcel | [Parcel Zero-Config Pipeline](./04-Bundler-Deep-Dives/Parcel-Zero-Config-Auto-Optimization-Gold-Sheet.md) |
| 11 | Modern build tools | [Modern Tools](./04-Bundler-Deep-Dives/Modern-Build-Tools-esbuild-Rollup-Turbopack-Metro-Gold-Sheet.md) |
| 12 | Performance pipeline | [Build Performance Pipeline](./05-Performance-Debugging-Architecture/Build-Performance-Pipeline-Cold-Start-Hot-Updates-Gold-Sheet.md) |
| 13 | Debugging builds | [Debugging Builds](./05-Performance-Debugging-Architecture/Debugging-Builds-Source-Maps-Bundle-Issues-Gold-Sheet.md) |
| 14 | Real-world pipeline design | [Pipeline Design](./05-Performance-Debugging-Architecture/Real-World-Build-Pipeline-Design-CICD-Gold-Sheet.md) |
